...
export function TabsTab({
  ...
  return (
    <BaseTabs.Tab
      className={cn(
        "relative h-10 shrink-0 rounded-full px-5 text-small font-semibold whitespace-nowrap text-fg-muted transition-colors duration-300 hover:text-fg focus-visible:outline-offset-2 data-[active]:text-canvas",
        className,
      )}
      {...props}
    />
