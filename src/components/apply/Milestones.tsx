            ...
            {[
              {
                ...
                gradient:
                  "bg-gradient-to-b from-[#1A1147] via-[#2D1B6B] to-[#44337A]",
                arrow: "#44337A",
              },
              {
                year: "2021",
                ...
                gradient:
                  "bg-gradient-to-b from-[#1E1454] via-[#321E75] to-[#483285]",
                arrow: "#483285",
              },
              {
                year: "2022",
                ...
                gradient:
                  "bg-gradient-to-b from-[#221761] via-[#37217F] to-[#4C3190]",
                arrow: "#4C3190",
              },
              {
                year: "2023",
                ...
                gradient:
                  "bg-gradient-to-b from-[#261A6E] via-[#3C2489] to-[#50349B]",
                arrow: "#50349B",
              },
              {
                year: "2024",
                ...
                gradient:
                  "bg-gradient-to-b from-[#2A1D7B] via-[#412793] to-[#5437A6]",
                arrow: "#5437A6",
              },
              {
                year: "2025",
                ...
                gradient:
                  "bg-gradient-to-b from-[#2E2088] via-[#462A9D] to-[#583AB1]",
                arrow: "#583AB1",
              },
            ].map((step, index, arr) => (
              <>
                ...
                >
                  <h4 className="text-2xl font-bold mb-6 w-full">
                    {step.year}
                  </h4>
