        ...
        <section className="container mx-auto max-w-4xl px-2 py-16">
            ...
            <div className="mb-8">
                ...
                <p className="text-lg text-gray-700 mb-4">
                    Our long-term vision and mission are the key components that drive us forward without losing our direction.
                </p>
                <div className="space-y-2">
                    ...
                    <p className="text-lg text-gray-700">
                        ...
                        TUM.ai connects students and all relevant stakeholders to facilitate the application of AI across domains and drive positive social impact through interdisciplinary projects.
                    </p>
                </div>
            </div>
        </section>
