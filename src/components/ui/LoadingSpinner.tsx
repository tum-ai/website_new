    ...
    >
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="relative">
          <div
            className={`${currentSize.spinner} border-white/30 rounded-full`}
          ></div>
          <div
            className={`absolute top-0 left-0 ${currentSize.spinner} border-white border-t-transparent rounded-full animate-spin`}
          ></div>
        </div>
      </div>
    </div>
