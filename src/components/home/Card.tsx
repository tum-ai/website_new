...
const Card = ({ text, title, desc, buttonText, link }: CardProps) => {
  return (
    <div className="absolute z-10 w-[38rem] h-[20rem] left-[3rem] bottom-[0.625rem] bg-white shadow-lg rounded-xl flex flex-col items-start px-6 py-8 justify-between">
