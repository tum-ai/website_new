const Grid = () => {
  const squares = [
    ...
    { id: 2, src: "/assets/home_img1.jpg", opacity: "opacity-10" },
    { id: 3, src: "/assets/home_img1.jpg", opacity: "opacity-20" },
    { id: 4, src: "/assets/home_img1.jpg", opacity: "opacity-10" },
    { id: 5, src: "/assets/home_img1.jpg", opacity: "opacity-20" },
    { id: 6, src: "/assets/home_img5.jpeg", opacity: "opacity-30" },
    { id: 7, src: "/assets/home_img4.jpg", opacity: "opacity-20" },
    { id: 8, src: "/assets/home_img2.png", opacity: "opacity-30" },
