...
export function ContentPage<T>({ title, description, tabs, collaborators, gradientColors }: ContentPageProps<T>) {
  return (
    <section className={`relative overflow-hidden p-8 text-white ${gradientColors || "bg-gradient-to-br from-blue-900 to-purple-900"} sm:py-16 lg:py-24`}>
      {/* Hero Section */}
      ...
      {/* Tabs Section */}
      <Tabs defaultValue={tabs[0].value} className="w-full flex items-center justify-center px-30">
      ...
      {collaborators?.logos && (
        <>
          ...
          <h3 className="mb-4 text-center text-3xl font-semibold">Collaborators</h3>
